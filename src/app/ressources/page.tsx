...
export const metadata = { title: 'Ressources — Marie Elgart Avocate' }
        ...
        <div className="max-w-6xl mx-auto px-6">
          ...
          <div style={{ marginBottom: '4rem' }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem', marginBottom: '1.2rem' }}>
              ...
              <span style={{ fontSize: '0.58rem', letterSpacing: '0.25em', color: '#2e5a3e', textTransform: 'uppercase' }}>Notes juridiques</span>
            </div>
            <h1 style={{ fontFamily: 'var(--font-playfair)', fontSize: 'clamp(1.7rem, 3vw, 2.4rem)', fontWeight: 400, color: '#1e3829', margin: 0, lineHeight: 1.20 }}>
              Ressources
            </h1>
          </div>
            ...
            {articles.map((a) => (
              <Link key={a.slug} href={`/ressources/${a.slug}`} style={{ textDecoration: 'none' }}>
                <article style={{
                  ...
                  <h2 style={{ fontFamily: 'var(--font-playfair)', fontSize: '1rem', fontWeight: 400, color: '#1e3829', margin: '0 0 1rem', lineHeight: 1.40, flex: 1 }}>
                    {a.titre}
                  </h2>
